//
//  CIHardLightBlendModeViewController.m
//  滤镜demo
//
...
#import "CIHardLightBlendModeViewController.h"

@interface CIHardLightBlendModeViewController ()

@end

@implementation CIHardLightBlendModeViewController
