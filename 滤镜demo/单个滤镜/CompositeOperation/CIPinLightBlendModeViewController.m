//
//  CIPinLightBlendModeViewController.m
//  滤镜demo
//
...
#import "CIPinLightBlendModeViewController.h"

@interface CIPinLightBlendModeViewController ()

@end

@implementation CIPinLightBlendModeViewController
