//
//  CIMorphologyMaximumViewController.m
//  滤镜demo
//
...
#import "CIMorphologyMaximumViewController.h"

@interface CIMorphologyMaximumViewController ()

@end

@implementation CIMorphologyMaximumViewController {
    CIImage *_image;
}
