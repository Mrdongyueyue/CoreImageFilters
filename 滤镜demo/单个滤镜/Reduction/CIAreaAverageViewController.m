...
#import "CIAreaAverageViewController.h"

@interface CIAreaAverageViewController ()

@end

@implementation CIAreaAverageViewController {
    CIImage *_ci_image;
    CIVector *_vector;
}
...
- (void)touchesMoved:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event {
    ...
    _vector = [CIVector vectorWithX:point.x Y:point.y Z:1 W:1];
    [self refilter];
}
