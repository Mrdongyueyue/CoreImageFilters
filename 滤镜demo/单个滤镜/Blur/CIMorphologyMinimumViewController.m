//
//  CIMorphologyMinimumViewController.m
//  滤镜demo
//
...
#import "CIMorphologyMinimumViewController.h"

@interface CIMorphologyMinimumViewController ()

@end

@implementation CIMorphologyMinimumViewController {
    CIImage *_image;
}
